...
class InvoiceRepository:
    ...
    def create(self,session,invoice_number,user_id,shopping_cart_id,created_at,billing_address,payment_method,payment_status,total_amount):
        try:
    ...
    def update(self,session,id,invoice_number=None,user_id=None,shopping_cart_id=None,created_at=None,billing_address=None,payment_method=None,payment_status=None,total_amount=None):
        try:
    ...
    def delete(self,session,invoice_id):
        try:
